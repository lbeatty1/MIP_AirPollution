...
######################################################
# 6.  Calculate emissions rates for new sources ######
######################################################
...
# 
# Then what about where?  In the ex-post analysis code, I put new facilities at retired sites first (up to previous capacity), then equally distribute capacity to retired/nonretired sites based on capacity.  
# In this new world where everything is endogenized, this doesn't really make sense since capacity is endogenous!  
#Moreover in typical scenarios, you'll see a lot more new capacity than retired capacity so it doesn't really make sense to put, say 200MW of capacity at a site that used to have a 25MW capacity.
# 
